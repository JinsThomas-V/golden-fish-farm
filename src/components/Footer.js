...
const Footer = () => {
  return (
    <footer
      style={{ backgroundColor: "#1b1b1b", color: "#fff", padding: "40px 0" }}
    >
      <Container>
        <Row className="text-center text-md-start">
          <Col md={4} className="mb-4 mb-md-0">
            ...
            <p>
              Dedicated to providing fresh, sustainable, and premium fish
              directly from our eco-friendly farm to your home.
            </p>
          </Col>
        ...
        <p className="text-center mb-0" style={{ color: "#aaa" }}>
          &copy; {new Date().getFullYear()} Shinto's Golden Fish Farm. All
          rights reserved.
        </p>
      </Container>
    </footer>
